...
(function(factory){
    ...
    $.extend(Sammy.Object.prototype, {
        ...
        // Escape HTML in string, use in KO-templates to prevent script injection.
        // Also aliased as `h()`
    ...
    Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        // whenever you're inside of an event context (KO-templates, routes, bind).
        //
        // ### Example
        //
        //     var app = $.sammy(function() {
        ...
        // a simple global cache for KO-templates. Uses the same semantics as
    ...
    // even with remote calls to fetch KO-templates.
    //
    ...
    Sammy.RenderContext.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        // This is useful for nesting KO-templates as part of the initial page load wrapped
        // in invisible elements or `<script>` tags. With template paths, the template
        // engine is looked up by the extension. For DOM/jQuery embedded KO-templates,
    ...
    Sammy.EventContext.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        // preloading/caching the KO-templates.
        load: function(location, options, callback) {
